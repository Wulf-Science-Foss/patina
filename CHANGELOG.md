...
All notable changes to Patina are documented here.
...
### Added
- Project structure: `CLAUDE.md`, `SPEC.md`, `THREAT_MODEL.md`, `CHANGELOG.md`
- Documentation scaffold: `docs/roadmap/`, `docs/specs/`, `docs/adr/`, `docs/prior-art/`
- Brand assets: logo (SVG, light/dark WebP variants)
